...
var app = {
	...
	bindEvents: function bindEvents() {
		var city = document.body.getAttribute('data-city');

		(0, _map2.default)(city);
		(0, _instagram2.default)(city);
	}
};
...
function map(city) {
	...
	(function (cityAttr) {
		...
		function initMap() {
			...
			var gMap = new google.maps.Map(document.querySelector('.' + mapCls), {
